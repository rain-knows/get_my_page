...
> 
> 相关文档：`docs/11-rich-editor-design.md`（文章写入链路的编辑器设计基线）
...
| FR-POST-003 | P0 | 管理员可创建/更新/删除文章 | 必须有权限校验；编辑器能力基线参见 `docs/11-rich-editor-design.md` | 管理员成功、未授权失败 |
...
| v1.1.1 | 2026-04-17 | 增加与富文本编辑器设计文档的关联，明确 FR-POST-003 的编辑器基线入口 |
