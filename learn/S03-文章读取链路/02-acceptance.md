...
## 执行命令
- curl -sS "http://localhost:8080/api/posts?page=1&size=10"
...
| 项目 | 命令 | 期望 | 实际 | 是否通过 |
|---|---|---|---|---|
| 成功路径 | curl -sS "http://localhost:8080/api/posts?page=1&size=10" | 返回 code=200 或可预期成功结构 | 待填写 | 待填写 |
| 失败路径 | curl -sS "http://localhost:8080/api/posts/not-exists-slug" | 返回明确错误码或失败状态 | 待填写 | 待填写 |
